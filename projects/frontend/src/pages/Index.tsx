      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden" style={{ zIndex: 0 }}>
        ...
        <div
          style={{
            ...
            left: '-8%',
            borderRadius: '50%',
            background: 'radial-gradient(circle at 60% 40%, #93c5fd 0%, #38bdf8 40%, #34d399 70%, transparent 100%)',
            filter: 'blur(40px)',
            opacity: 0.75,
        ...
        <div
          style={{
            ...
            left: '-5%',
            borderRadius: '50%',
            background: 'radial-gradient(circle at 60% 50%, #bbf7d0 0%, #fef9c3 50%, #fde68a 80%, transparent 100%)',
            filter: 'blur(40px)',
            opacity: 0.55,
